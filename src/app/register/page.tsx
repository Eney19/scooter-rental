  ...
  if (signed) return (
    <div className="min-h-screen bg-blue-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl p-8 text-center shadow-lg max-w-md w-full">
        ...
        <p className="text-slate-500 mt-2 mb-4">Копію договору надіслано на ваш email. Очікуйте на зв'язок від менеджера.</p>
        {contractPdfUrl && (
          <a href={contractPdfUrl} target="_blank" className="inline-block bg-blue-600 text-white rounded-xl px-6 py-3 font-semibold hover:bg-blue-700">
        ...
        {step === 2 && (
          <form onSubmit={handleStep2} className="bg-white rounded-2xl shadow-lg p-6 space-y-4">
            ...
            <div><label className={lbl}>Адреса проживання *</label>
              <input type="text" required value={form.address} onChange={e=>set("address",e.target.value)} className={inp} placeholder="вул. Шевченка, 1, кв. 10"/>
            </div>
