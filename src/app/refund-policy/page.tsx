      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="prose prose-slate max-w-none space-y-6 text-slate-700 leading-relaxed">
          ...
          <section>
            ...
            <p className="mt-2">
              Кошти повертаються на банківську картку, з якої було здійснено оплату, протягом строків, встановлених платіжною системою Monobank (зазвичай до 14 банківських днів).
            </p>
          </section>
